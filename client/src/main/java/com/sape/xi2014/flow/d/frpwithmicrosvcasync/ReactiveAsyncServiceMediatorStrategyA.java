...
public class ReactiveAsyncServiceMediatorStrategyA implements ServiceMediator {
  ...
  public static void main(String[] args) throws Exception {
    ClientResponse searchResults = new ReactiveAsyncServiceMediatorStrategyA().getAggregatedResponse("shoes");
    Thread.sleep(60000);
